...
describe("SpecsPanel", () => {
    ...
    seed([
      {
        ...
        items: [
          {
            label: "proposal.md",
            path: ".openspec/changes/add-logging/proposal.md",
            isSpec: false,
          },
          {
            label: "logging/spec.md",
            path: ".openspec/changes/add-logging/specs/logging/spec.md",
            isSpec: true,
          },
        ],
      },
  ...
  it("clicking a document opens its full path", async () => {
    ...
    expect(useProject.getState().open).toHaveBeenCalledWith(`${ROOT}/.openspec/specs/auth/spec.md`)
  })
})
