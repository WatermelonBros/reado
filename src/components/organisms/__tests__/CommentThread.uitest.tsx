...
describe("CommentThread", () => {
  ...
  it("typing a reply and submitting calls the reply action with the trimmed body", async () => {
    ...
    await userEvent.type(screen.getByPlaceholderText("comment.replyPlaceholder"), "  looks good  ")
  ...
  it("hides the send-to-agent action for a note (non-task) comment", () => {
    seed()
    renderThread(mkComment())
    expect(screen.queryByRole("button", { name: "terminal.sendReview" })).not.toBeInTheDocument()
  })
